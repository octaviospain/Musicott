 ...
 */
public class PlayQueueModule extends AbstractModule implements ControllerModule<PlayQueueController> {

    private PlayQueueController controller;

    public PlayQueueModule(PlayQueueController controller) {
    ...
    @Provides
    @PlayQueueCtrl
    public PlayQueueController providesController() {
        return controller;
    }
}