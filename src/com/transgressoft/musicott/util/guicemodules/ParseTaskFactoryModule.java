 ...
 * classes using a {@link ParseTaskFactory}.
 *
 ...
 * @since 0.10.1-b
 */
public class ParseTaskFactoryModule extends AbstractModule {

    public static final String ITUNES_PARSE = "ItunesParse";
    public static final String AUDIO_PARSE = "AudioParse";

    @Override
    protected void configure() {
        Module parseTaskFactoryModule = new FactoryModuleBuilder()
                .implement(ParseTask.class, Names.named(ITUNES_PARSE), ItunesParseTask.class)
                .implement(ParseTask.class, Names.named(AUDIO_PARSE), AudioFilesParseTask.class)
