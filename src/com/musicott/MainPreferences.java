...
public class MainPreferences {
	...
	/**
	 * The sequence number of the keys of the {@link com.musicott.model.Track} map
	 */
	private static final String TRACK_SEQUENCE = "track_sequence";

	/**
	 * The sequence number of the keys of the {@link com.musicott.model.Playlist} map
	 */
	 ...
	 * or the next integer to use for the {@link com.musicott.model.Track} map
	 *
