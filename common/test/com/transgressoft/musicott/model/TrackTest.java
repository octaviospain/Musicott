...
public class TrackTest {
    ...
    void constructorTest() {
        ...
        Awaitility.await().untilAsserted(() -> assertTrue(track.lastDateModifiedProperty().get().isBefore(LocalDateTime.now())));
        Awaitility.await().untilAsserted(() -> assertTrue(track.getDateAdded().isBefore(LocalDateTime.now())));
