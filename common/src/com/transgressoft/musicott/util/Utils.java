...
public class Utils {
    ...
    private static final String LOGGING_PROPERTIES = "common/resources/config/logging.properties";
    ...
    public static boolean updateCoverImage(Track track, ImageView imageView) {
        ...
        if (track.getCoverImage().isPresent()) {
            ...
            Image defaultCoverImage = new Image(Utils.class.getResourceAsStream(DEFAULT_COVER.toString()));
            imageView.setImage(defaultCoverImage);
        }
    ...
    public static Alert createAlert(String title, String header, String content, AlertType type, Stage stage) {
        ...
        alert.getDialogPane().getStylesheets().add(Utils.class.getResource(CommonObject.DIALOG_STYLE.toString()).toExternalForm());
